...
export function TwitterIcon({ size = 24, color = "#000000" }: SvgIconProps) {
  return (
...
export function LinkedinIcon({ size = 24, color = "#000000" }: SvgIconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 48 48" fill="none">
      <G id="SVGRepo_bgCarrier" stroke-width="0"></G>
      <G
...
export function InstagramIcon({ size = 24, color = "#000000" }: SvgIconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 48 48" fill="none">
      <G id="SVGRepo_bgCarrier" stroke-width="0"></G>
      <G
      ...
      <G id="SVGRepo_iconCarrier">
        <Defs>
          <RadialGradient
            id={`instagram_gradient_0_ea3sc5a`}
            cx="0"
            cy="0"
            r="1"
            gradientUnits="userSpaceOnUse"
            gradientTransform="translate(18 35) rotate(-55.3758) scale(38.2794)">
            <Stop stopColor="#B13589"></Stop>
            <Stop offset="0.79309" stopColor="#C62F94"></Stop>
            <Stop offset="1" stopColor="#8A3AC8"></Stop>
          </RadialGradient>
          <RadialGradient
            id={`instagram_gradient_1_ea3sc5a`}
            cx="0"
            cy="0"
            r="1"
            gradientUnits="userSpaceOnUse"
            gradientTransform="translate(16.5 46.5) rotate(-65.1363) scale(33.8913)">
          ...
          <RadialGradient
            id={`instagram_gradient_2_ea3sc5a`}
            cx="0"
            cy="0"
            r="1"
            gradientUnits="userSpaceOnUse"
            gradientTransform="translate(0.75 4.5) rotate(-8.1301) scale(58.3364 12.4775)">
        ...
        <Circle
          ...
          cy="24"
          r="20"
          fill={`url(#instagram_gradient_0_ea3sc5a)`}></Circle>
        <Circle
          cx="24"
          cy="24"
          r="20"
          fill={`url(#instagram_gradient_1_ea3sc5a)`}></Circle>
        <Circle
          cx="24"
          cy="24"
          r="20"
          fill={`url(#instagram_gradient_2_ea3sc5a)`}></Circle>
