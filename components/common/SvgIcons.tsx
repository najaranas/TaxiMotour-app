...
export function AppleIcon({ size = 24, color = "#000000" }: SvgIconProps) {
  return (
    <Svg fill={color} width={size} height={size} viewBox="0 0 50 50">
...
export function MoonIcon({ size = 24, color = "#1C274C" }: SvgIconProps) {
  return (
...
export function LanguageIcon({ size = 24, color = "#000000" }: SvgIconProps) {
  return (
    <Svg
      viewBox="0 0 24 24"
      width={size}
